                ...
                <div class="card card-login">
                    ...
                    <div class="card-body mt-2 mb-3">
                        ...
                        <CustomInput
                                ...
                                inputValidationRules="required"
                                inputType="text"
                                :input-placeholder="'Your ' + (user.organization_type === 'seller' ? 'shop name' : 'marketplace name')"
                        />
                    ...
                    <div class="text-center mt-3 mb-4">
                        <button v-on:click="submitRegistration" class="btn btn-primary btn-wd btn-lg">I register
                        </button>
                    </div>
                </div>
            </div>
